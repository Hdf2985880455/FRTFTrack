...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, display_name: str = None,
        ...
        result_suffix = os.environ.get("MMTRACK_RESULT_SUFFIX", "").strip()
        if result_suffix:
            safe_suffix = result_suffix.replace("/", "_").replace(" ", "_")
            self.results_dir = "{}_{}".format(self.results_dir, safe_suffix)
    ...
    def run_sequence(self, seq, debug=None, multiobj_mode=None):
        ...
        init_info['dataset_name'] = seq.dataset
